...
extern NSString *const PAGE_NAVIGATE_FROM_MESSAGES_TO_FRIENDS;
extern NSString *const PAGE_NAVIGATE_FROM_CONFESSIONS_TO_MESSAGES;
extern NSString *const PAGE_NAVIGATE_FROM_CONFESSIONS_TO_FRIENDS;
extern NSString *const PAGE_NAVIGATE_FROM_FRIENDS_TO_CONFESSIONS;
extern NSString *const PAGE_NAVIGATE_FROM_FRIENDS_TO_CONTACTS;
