...
NSString *const FORGOT_PASSWORD_EMAIL = @"Hey Versapp -\n\nI have forgotten my password and need it reset.\n\nThanks!";
...
NSString *const THOUGHTS_URL = @"https://versapp.co/thoughts/";
NSString *const THOUGHTS_BY_ID_URL = @"https://versapp.co/thoughts/thought/";
...
NSString *const DOWNLOAD_URL = @"http://harmon.dev.versapp.co/gcs/download.php";
NSString *const BLACKLIST_URL = @"http://harmon.dev.versapp.co:5281/contacts/store";
...
NSString *const THOUGHTS_BY_ID_URL = @"http://harmon.dev.versapp.co/thoughts/thought/";
*/
